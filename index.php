...
<head>
	...
	<link rel="stylesheet" type="text/css" href="res/style/MContent/infobox.css">
	...
	<link rel="stylesheet" type="text/css" href="res/style/MContent/footer.css">
...
<main>
		...
		<MContent>
			...
			<mcontent class="section">
				<!-- INFO BOX WILL BE HERE -->
					<infobox>
						<?php include("scripts/infobox.php") ?>
					</infobox>
			</mcontent>
			<mcontent class="section">
			<!-- NEWS -->
	...
	<footer>
		...
		<footer class="text">
			...
			<span style="font-size: 16px;opacity: 1;">&copy</span>
			<i><span title="(PHP & JavaScript)">Dave</span> & <span title="(HTML & CSS design)">Foodie</i></span> <b>productions</b>
		</footer>
		</footer>
		...
		<footer class="right">
			<li>
				<a href="#">FAQ</a>
				<a href="#">CONCATCT US</a>
				<a href="#">ABOUT US</a>
				<a href="#">BUG & UPDATE LIST</a>
			</li>
		</footer>
	</footer>
